        ...
        <div class="row">
            <div class="col-md-12">
                <div class="block text-center">
                    <h1 class="text-capitalize mb-5 text-lg">Hospital Details</h1>
                </div>
            </div>
        </div>
    </div>
...
<div class="container py-5">
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            {{-- Uncomment below if you want to show address and phone --}}
            {{--
            <p>
            ...
            {{-- Uncomment below if you want to display the "View on Google Maps" button --}}
            {{--
